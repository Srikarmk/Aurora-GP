...
nine, beating both regional noise and a heteroscedastic GP. The gains exist only at
levels of input-dependent noise some $200\times$ beyond any we measured in real data.
\end{abstract}
...
calibrated. On $\ece$ the conclusion is unambiguous: \textbf{neither input-dependent
noise model improves calibration over a single global noise parameter on real data}. The
