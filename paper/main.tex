...
\begin{table}[h]\centering
\caption{$\ece$ on real data, ordered by measured input-dependent residual variance.
A single global noise parameter wins on eight of nine datasets. Regional noise is
actively harmful where it loses (yacht, robot\_arm). $p$ from a Wilcoxon signed-rank
test on the ten paired per-seed differences between regional and heteroscedastic.}
\label{tab:noise}
\begin{tabular}{lrrrrr}
\toprule
dataset & het & global & het-GP (EM) & regional & $p$ \\
\midrule
energy      & 7.05 & \textbf{0.0385} & 0.0940 & 0.0792 & 0.695 \\
airfoil     & 4.44 & \textbf{0.0784} & 0.0971 & 0.0920 & 0.557 \\
calhousing  & 4.10 & \textbf{0.0693} & 0.1549 & \textbf{0.0693} & 0.002 \\
concrete    & 3.88 & \textbf{0.0400} & 0.1259 & 0.0660 & 0.002 \\
yacht       & 3.55 & \textbf{0.0648} & 0.0741 & 0.2515 & 0.002 \\
wine\_white & 2.75 & \textbf{0.0216} & 0.1680 & 0.0345 & 0.004 \\
robot\_arm  & 2.60 & \textbf{0.0163} & 0.0421 & 0.0989 & 0.002 \\
powerplant  & 2.45 & \textbf{0.0197} & 0.1839 & 0.0214 & 0.002 \\
protein     & 2.19 & \textbf{0.0189} & 0.1127 & 0.0446 & 0.002 \\
\bottomrule
\end{tabular}
\end{table}

On NLL the picture is milder --- regional noise wins on five of nine, global on three
--- but on $\ece$ the conclusion is unambiguous: \textbf{neither input-dependent noise
model improves calibration over a single global noise parameter on real data}. The
